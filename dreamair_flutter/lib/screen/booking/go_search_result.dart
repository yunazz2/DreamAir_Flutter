...
class GoSearchResult extends StatefulWidget {
  ...
  @override
  State<GoSearchResult> createState() => _GoSearchResultState();
}
...
class _GoSearchResultState extends State<GoSearchResult> {
  ...
  Future<void> getBookingList() async {
    var url = 'http://13.209.3.162/booking/goList?roundTrip=$roundTrip&departure=$departure&destination=$destination&departureDate=$departureDate&pasCount=$pasCount' ;
