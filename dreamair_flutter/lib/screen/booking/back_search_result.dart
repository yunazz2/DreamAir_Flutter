...
class _BackSearchResultState extends State<BackSearchResult> {
  ...
  Future<void> getBookingList() async {
    var url = 'http://54.180.125.242/booking/comeList?roundTrip=$roundTrip&departure=$departure&destination=$destination&departureDate=$departureDate&pasCount=$pasCount' ;
